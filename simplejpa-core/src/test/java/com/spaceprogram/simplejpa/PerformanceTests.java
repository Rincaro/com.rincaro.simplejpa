...
public class PerformanceTests extends BaseTestClass {
    ...
    public void testLazyListRetrievalPerformance() throws InterruptedException, ExecutionException {
        ...
        this.printAndLog("duration of persists=" + duration);
        ...
        this.printAndLog("duration of retreival and prints=" + duration);
        ...
        duration = System.currentTimeMillis() - start;
        this.printAndLog("duration of retreival and prints after first load=" + duration);
